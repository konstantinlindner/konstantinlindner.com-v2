...
function Projects() {
  return (
    <>
      ...
      <VStack spacing="10" mt="10" direction="column" mx="auto" align="center">
            ...
            <CardBody>
              ...
              <Stack mt="6" spacing="3">
                ...
                <Text>
                  ...
                  Hanks. With his love for knowledge and entertainment, Hanx101
                  brings an immersive trivia experience right to your
                  fingertips. Featuring intuitive gameplay and stunning visuals,
                  Hanx101 keeps you hooked with its ever-expanding question
                  database and exciting rewards.
                </Text>
              </Stack>
            </CardBody>
            <Divider />
            ...
            <CardBody>
              ...
              <Stack mt="6" spacing="3">
                ...
                <Text>
                  ...
                  visualize your personal finances, health and life stats in one
                  tool.
                </Text>
              </Stack>
            </CardBody>
