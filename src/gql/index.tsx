...
export type PhotoModelFilter = {
  ...
  img?: InputMaybe<FileFilter>;
  imgtxt?: InputMaybe<StringFilter>;
...
export enum PhotoModelOrderBy {
  ...
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  ImgtxtAsc = 'imgtxt_ASC',
  ImgtxtDesc = 'imgtxt_DESC',
  UpdatedAtAsc = 'updatedAt_ASC',
  UpdatedAtDesc = 'updatedAt_DESC'
}

/** Record of type Photo (photo) */
...
export type FullPhotoFragment = { __typename?: 'PhotoRecord', id: any, imgtxt?: string | null, img?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: any, height: any, aspectRatio: any, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null };

export type AllPhotosQueryVariables = Exact<{ [key: string]: never; }>;


export type AllPhotosQuery = { __typename?: 'Query', allPhotos: Array<{ __typename?: 'PhotoRecord', id: any, imgtxt?: string | null, img?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: any, height: any, aspectRatio: any, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null }> };

export const FullPhotoFragmentDoc = gql`
    fragment FullPhoto on PhotoRecord {
  id
  imgtxt
  img {
    responsiveImage(imgixParams: {fit: crop, dpi: "1"}) {
      srcSet
      webpSrcSet
      sizes
      src
...
export function useAllPhotosQuery(baseOptions?: Apollo.QueryHookOptions<AllPhotosQuery, AllPhotosQueryVariables>) {
        ...
        return Apollo.useQuery<AllPhotosQuery, AllPhotosQueryVariables>(AllPhotosDocument, options);
      }
export function useAllPhotosLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllPhotosQuery, AllPhotosQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllPhotosQuery, AllPhotosQueryVariables>(AllPhotosDocument, options);
        }
